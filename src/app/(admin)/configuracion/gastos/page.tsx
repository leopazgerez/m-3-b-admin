    ...
    <>
      ...
      <main className="p-8 flex flex-col gap-6 max-w-5xl w-full">
        ...
        <div className="bg-white rounded-2xl border border-[#E7DFD2] p-6 shadow-xs flex flex-col gap-4">
          ...
          <form onSubmit={handleAddExpenseType} className="flex gap-3 pt-2">
            <input
              type="text"
              required
        ...
        <div className="bg-white rounded-2xl border border-[#E7DFD2] shadow-xs overflow-hidden flex flex-col">
          <div className="bg-[#FBF8F2] px-6 py-3.5 flex items-center justify-between text-[11px] font-semibold text-[#A89C8C] tracking-wide border-b border-[#E7DFD2]">
            <div className="flex-1">RUBRO / TIPO DE GASTO</div>
            <div className="w-44 text-center">MOVIMIENTOS ASOCIADOS</div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-44 text-center">
                      <span className="bg-[#FBEFD9] text-[#D98A2B] font-medium px-3 py-1 rounded-full text-xs">
